...
<script type="text/javascript">
	jQuery(document).ready(function(){
		...
		jQuery("#edit").validationEngine();
            ...
            //$(".datepicker1").mask("99/99/99 99:99");     
 ...
 <form id="edit" action="bin/insere_stock.php?id=1&voltar=stock.php" method="post" enctype="multipart/form-data">
	<input type='hidden' value='historico_stock' name='varNomeTabela'>
	<input type='hidden' value='stock.php' name='local'>
											...
											<tr>
												<td class="TitleTopic"><span id="ConnectFramework_wt7_block_wt1_wtTABZONE">
													<table class='tabs' cellpadding='0' cellspacing='0'>
														<tr>
														<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
														<td  id='TAB1' class='on'  ><a  onclick="javascript:showProcessing('processing');" href='abastecimento_mes.php'>&nbsp;Abastecimentos Mês</a></td>
														...
														<td  id='TAB4' class='on'><a  onclick="javascript:showProcessing('processing');" href='update_stock.php'>&nbsp;Entrada Stock</a></td>
															...
															<tr>
																...
																<table style="width: 100%; border-spacing: 0px" cellspacing="0" cellpadding="0" border="0">
																	...
																	<tr>
																		...
																		<td class="FieldCaption" style="width: 150px">Data Abastecimento (AAAA-MM-DD HH:mm):</td>
																
																		<td class="EditRecord_Value">
																		<input type='text' name='data_abastecimento' value="<?=date('Y-m-d G:i')?>" class='validate[required] text-input   datepicker1'>
																	</tr>
														
																	
																	<tr>																
																<td class="FieldCaption" style="width: 150px">Litros  :</td>
																		<td class="EditRecord_Value"><input type='text' name='litros' class='validate[required] text-input'></td></td>

																		</td>
															
																		<td class="FieldCaption" style="width: 150px">Preço por litro  :</td>
																		<td class="EditRecord_Value"><input type='text' name='preco_litro' class='validate[required] text-input'></td></td>
